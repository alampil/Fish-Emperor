...
<head>
  ...
  <title>Fish-Emperor Контакти</title>
		...
		<div class="row ">
			<div class="col-lg-3 pt-3 left-menu">
				<ul class="info-menu">
					...
					<li><a class="active-link" href="contact.html">Контакти</a></li>
          ...
          <center>
			...
			<div class="col-lg-9 pt-3 contacts">
				<section class="inner-article-section">
					<div class="section-title big-size"><h3 class="big-size">Контакти</h3></div>
						<article class="article-details">
							<div class="text-block">
								<p>Ми завжди готові надати вам кваліфіковану пораду або допомогу з вибором того, що вам потрібо з асортименту нашого магазину.</p>
								<h3 class="big-size">ТЕЛЕФОНИ</h3>
								<p>
									<span class="address-phone">+38(096)580-76-15</span>
									<br>
									<span class="address-phone">+38(097)XXX-XX-XX</span>
									<br>
									<span class="address-phone">E-mail: alampil@mail.ua
									</span>
									<br>
								</p>
								<h3 class="big-size">ЧАС РОБОТИ</h3>
								<p>
									<span class="address-phone">Пн. — Пт.: з 9:00 до 18:00</span>
									<br>
									<span class="address-phone">Суббота: з 10:00 до 17:00</span>
									<br>
									<span class="address-phone">Неділя: вихідний
									</span>
									<br>	
								</p>							
								<h3 class="big-size">МИ В СОЦ. МЕРЕЖАХ</h3>
								<p>
									<span class="address-phone fb"><a href="#">Facebook</a></span>
									<br>		
									<span class="address-phone gg"><a href="#">Google</a></span>
									<br>		
									<span class="address-phone tw"><a href="#">Twitter</a></span>
									<br>																									
								</p>
							</div>
						</article>
								...
								<div class="col-lg-4">
									...
									<div class="form-list">
										<form action="#" method="post" name="submit">
											<div class="line">
												<input type="text" name="phone" class="phone-mask" placeholder="Мобільний телефон" _required="required" value="" />
											</div>
											<div class="line">
												<input type="text" name="name" placeholder="Ім'я" _required="required" value="" />
											</div>
											<div class="line">
												<input type="text" name="citu" placeholder="Місто" />
											</div>
											<div class="line">
												<input type="text" name="email" placeholder="E-mail" _required="required" value="" />
											</div>
											<div class="line">
												<textarea name="message" placeholder="Коментарій" _required="required" value=""></textarea>
											</div>
											<input name="subj" type="hidden" value="Форма зворотнього зв'язку" />
											<input type="hidden" name="sent_to" value="1" />
											<button class="btn btn-lg btn-primary btn-block btn-primary tell-me-link" type="submit" name="topurchases">Ввідправити за'явку</button>
										</form>
									</div>
								</div>
								<div class="col-lg-8">
